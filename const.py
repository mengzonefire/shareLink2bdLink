...
p_md5 = re.compile(
    r"'content-md5': '([\da-f]{32})'", flags=re.IGNORECASE)  # 忽略大小写
errno_msg = {-9: '提取码错误', 114: '链接格式错误', 514: 'share_uk和shareid获取失败', 119: '文件已被和谐',
             1919: '链接已失效', 810: '账号cookie已失效', 115: 'fileList获取失败', 116: 'dlink获取失败, 请尝试更换cookie', 996: '文件md5获取失败, 请下载后本地生成'}
default_msg = '未知错误'
